...
@Component({
    ...
    template: `
        <div class="matrix-container">
            <div class="matrix">
                <tr *ngFor="let nodex of algorithmsService.adjConnections; let i = index; trackBy: trackById">
                    ...
                    <td *ngFor="let nodey of algorithmsService.adjConnections; let j = index; trackBy: trackById">
                        ...
                        <mat-checkbox [checked]="nodey[i]" (change)="algorithmsService.clickAdjMatrix(i,j)" style="margin-right: 2px; margin-left: 2px;"></mat-checkbox>
                    </td>
                </tr>    
            </div>
        </div>
